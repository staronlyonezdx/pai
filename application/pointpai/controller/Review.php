...
class Review extends MemberHome
{
	...
	*/
    ...
    public function get_gp_review_list(){
        ...
        $field='po.o_id,po.o_point,po.o_periods,po.o_addtime,po.o_paytime,prg.rg_content,pro.add_time as ro_add_time,prg.rg_id,po.gp_num,prg.gp_id,m.m_id,m.m_name,m.m_avatar,prg.goods_score';
        $limit = (($page-1) * $size).','.$size;
