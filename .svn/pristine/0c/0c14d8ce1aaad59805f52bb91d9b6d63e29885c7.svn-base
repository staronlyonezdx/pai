...
class Index extends IndexHome
{
    ...
    public function double11(){
        ...
        $array1 = ['start_date'=>$data.' 11:30:00','end_date'=>$data.' 12:30:00','is_active'=>1];//1541208600,1541215800
        $array2 = ['start_date'=>$data.' 13:30:00','end_date'=>$data.' 14:30:00','is_active'=>0];//1541223000
        $array3 = ['start_date'=>$data.' 15:30:00','end_date'=>$data.' 16:30:00','is_active'=>0];//1541939400,1541230200
        $array4 = ['start_date'=>$data.' 17:30:00','end_date'=>$data.' 18:30:00','is_active'=>0];//1541237400
        $array5 = ['start_date'=>$data.' 19:30:00','end_date'=>$data.' 20:30:00','is_active'=>0];//1541244600
        $array6 = ['start_date'=>$data.' 21:30:00','end_date'=>$data.' 22:30:00','is_active'=>0];//1541244600
    ...
    /**
     * 修改活动商品活动时间
     * http://www.pai.com/promotion/index/mytest/data/2018-11-08
     */
    public function mytest(){
        $data = input('param.data/s','2018-11-08');
        if(strlen($data) != 10){
            $data = '2018-11-11';
        }
        die;
        ...
        $data_s1 = strtotime($data." 10:00:00");
        $data_e1 = strtotime($data." 10:30:00");

        $data_s2 = strtotime($data." 11:00:00");
        $data_e2 = strtotime($data." 11:30:00");

        $data_s3 = strtotime($data." 12:00:00");
        $data_e3 = strtotime($data." 12:30:00");

        $data_s4 = strtotime($data." 13:00:00");
        $data_e4 = strtotime($data." 13:30:00");

        $data_s5 = strtotime($data." 14:00:00");
        $data_e5 = strtotime($data." 14:30:00");

        $data_s6 = strtotime($data." 15:00:00");
        $data_e6 = strtotime($data." 15:30:00");
     ...
     * 下一个福袋上线
     * 刘勇豪
     * http://www.pai.com/promotion/index/sale_next_fudai
     */
