<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"D:\project\pai\public/../application/admin/view/adminuser/adminedit.html";i:1541491286;s:64:"D:\project\pai\public/../application/admin/view/common/base.html";i:1543283930;}*/ ?>
...
<div class="container-fluid">
    <div class="panel panel-default">
        <div class="panel-body">
            <form method="post" action="<?php echo url('Adminuser/adminedit'); ?>" id="edit_form" onsubmit="return form_submit()">
                <div class="form-group from_add_authority">
                    <label>管理员信息编辑</label>
                </div>
                <div class="form-group from_add_margin">
                    <label>账号</label>
                    <input type="text" name="admin_name" class="form-control" placeholder="账号" value="<?php echo (isset($adminInfo['admin_name']) && ($adminInfo['admin_name'] !== '')?$adminInfo['admin_name']:''); ?>">
                </div>
                <?php if(empty($adminInfo) || (($adminInfo instanceof \think\Collection || $adminInfo instanceof \think\Paginator ) && $adminInfo->isEmpty())): ?>
                ...
                <div class="form-group">
                    <label>确认密码</label>
                    <input type="password" name="admin_pwd2" class="form-control" placeholder="确认密码">
                </div>
                <?php endif; ?>
                <div class="form-group">
                    <label>管理员角色</label>
                    <select name="role_id" class="form-control">
                        ...
                        <?php if(!(empty($adminInfo) || (($adminInfo instanceof \think\Collection || $adminInfo instanceof \think\Paginator ) && $adminInfo->isEmpty()))): if($adminInfo['role_id'] ==
                        $role['role_id']): ?>selected<?php endif; endif; ?>
                        >
                ...
                <div class="form-group text-right" style="margin-top:20px">
                    <input type="hidden"  name="admin_id" value="<?php echo (isset($admin_id) && ($admin_id !== '')?$admin_id:0); ?>" />
                    <input type="submit" class="btn btn-primary" id="submit" value="保存信息">
                    <input type="reset" class="btn btn-primary" value="取消操作">
                </div>
            </form>
        </div>
    </div>
