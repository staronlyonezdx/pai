<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"D:\project\pai\public/../application/admin/view/api/apitokenlist.html";i:1541491286;s:64:"D:\project\pai\public/../application/admin/view/common/base.html";i:1543283930;}*/ ?>
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <table class="table table-hover" style="margin-bottom:0">
                ...
                <tbody>
                <?php if(!(empty($list) || (($list instanceof \think\Collection || $list instanceof \think\Paginator ) && $list->isEmpty()))): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?></td>
                    <td><?php echo $vo['at_id']; ?></td>
                    <td><?php echo $vo['at_name']; ?></td>
                    <td><?php echo $vo['at_token']; ?></td>
                    <td><?php echo $vo['at_interval_time']; ?></td>
                    <td>
                        <a href="<?php echo url('api/apitokenadd',['id'=>$vo['at_id']]); ?>">
                            编辑
                        </a>
                        <a href="<?php echo url('api/apitokenpwd',['id'=>$vo['at_id']]); ?>">
                            修改密码
                        </a>
