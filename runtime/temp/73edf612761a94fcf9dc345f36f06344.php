<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:79:"D:\project\pai\public/../application/member/view/goodsproduct/chaozhi_rule.html";i:1543217422;s:65:"D:\project\pai\public/../application/member/view/common/base.html";i:1543280491;s:67:"D:\project\pai\public/../application/member/view/common/js_sdk.html";i:1541491283;}*/ ?>
...
<main>
    <div class="rule_top clear">
        <div class="rule_top_text lf">
            <p style="color:#F8405C">拍吖吖超值团购规则</p>
            <span>超值团购商品参购流程规则</span>
    ...
    <div class="rule_main">
        <div class="rule_list">
            <div class="rule_bg_img">
                <img src="__STATIC__/image/goodsproduct/icon2@2x.png" alt=""/>
            </div>
            <p>超值团购商品参购流程</p>
        </div>
        <div class="rule_main_img" style="width:4.91rem;height:7.64rem">

            <img src="__STATIC__/image/goodsproduct/liucheng@2x (1).png" alt=""/>
        </div>
        <div>
            <div class="rule_list">
                <div class="rule_bg_img">
            ...
            <div class="rule_mian_text">
                <span style="line-height: 0.42rem;">超值团购商品是拍吖吖新推出的福利商品，用户可以用低价购得超值商品，每轮参与者将有一人同时获得超值商品与惊喜赠品。惊喜赠品以具体商品详情中为准哦！</span>
            </div>
        </div>
    </div>
</main>
