    ...
    <div class="paier_info_view">
        ...
        <div class="paier_info_list">
            <?php switch($vo['oa_state']): case "1": ?>
                ...
                <?php break; case "2": if($is_fudai == 1): ?>
