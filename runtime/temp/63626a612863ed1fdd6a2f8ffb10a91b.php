    ...
    <div class="details_top clear">
        ...
        <div class="yg-num">
            ...
            <div class="details_top_lf clear">
                <p><img src="__STATIC__/image/goodsproduct/icon_chaozhigou@2x.png" alt="" style="margin-right:0.1rem;width:0.8rem;height:0.3rem;margin-top:0.08rem;float: left;"><?php echo $goods['g_name']; ?></p>
                <span><?php echo $goods['g_secondname']; ?></span>            
            </div>
            <?php elseif($goods['is_huodong']==1): ?>
                <div class="details_top_lf clear">
                    <p><img src="__STATIC__/image/goodsproduct/Icon_11biaoshi@2x.png" alt="" style="margin-right:0.1rem;width:0.8rem;height:0.3rem;margin-top:0.08rem;float: left;"><?php echo $goods['g_name']; ?></p>
                    <span><?php echo $goods['g_secondname']; ?></span>            
                </div>
            <?php else: ?>
        ...
        <div class="details_carousel">
            <div class="details_schedule_top clear">
                ...
                <?php if($goods['is_fudai']==1): if($goods['gp_state']==1 && $goods['g_starttime'] <= $time && $goods['g_endtime'] > $time): ?>
                    ...
                    <?php else: ?>
                        <div class="details_schedule_right_btn rt" style="background:#E2E2E2 ;color:#aaaaaa;" gdr_id="<?php echo $vo['gdr_id']; ?>" disabled="disabled">
                            参团
                        </div>
            ...
            <div class="details_evaluate_list clear">
                ...
                <div class="details_evaluate_rt lf">
                    ...
                    <div class="details_pingjia_view clear">
                        ...
                        <img src="__STATIC__/image/index/pic_home_taplace@2x.png" data-original="__CDN_PATH__<?php echo $vo['img_list'][0]['img_url']; ?>"/>
                        <?php endif; ?>
                    <!--评价内容E-->
                    </div>
                </div>
    ...
    <div class="details_canpai_main">
        <div class="details_canpai_top clear">
            ...
            <div class="details_canpai_text lf">
                <p class="details_canpai_tit"><?php echo (isset($goods['g_name']) && ($goods['g_name'] !== '')?$goods['g_name']:''); ?></p>
...
<div class="detail-btn phonex"><span onclick="cancel(<?php echo $goods['g_id']; ?>)">取消发布</span><a class="link" href="/member/store/deposit/g_id/<?php echo $goods['g_id']; ?>">支付保证金</a>
</div>
<?php endif; ?>
<!-- 分享弹窗 S -->
<div class="share-pop">
...
//出售中的时间
$(function () {
    var end_time = <?php echo $goods['g_endtime']; ?> * 1000 - nowTime;
