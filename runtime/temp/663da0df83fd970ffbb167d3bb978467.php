<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:78:"D:\project\pai\public/../application/member/view/goodsproduct/peanut_rule.html";i:1544075644;s:65:"D:\project\pai\public/../application/member/view/common/base.html";i:1543280491;s:67:"D:\project\pai\public/../application/member/view/common/js_sdk.html";i:1541491283;}*/ ?>
...
<main>
    <div class="rule_top clear">
        <div class="rule_top_text lf">
            <p style="color:#FFD200">拍吖吖花生堂规则</p>
            <span>花生堂商品参购流程规则</span>
    ...
    <div class="rule_main">
        <div class="rule_list">
            <div class="rule_bg_img">
                <img src="__STATIC__/image/activity/icon@2x.png" alt=""/>
            </div>
            <p>花生堂商品参购流程</p>
        </div>
        <div class="rule_main_img" style="width:4.91rem;height:6.08rem">

            <img src="__STATIC__/image/activity/liucheng@2x.png" alt=""/>
        </div>
        <div>
            <div class="rule_list">
                <div class="rule_bg_img">
            ...
            <div class="rule_mian_text">
                <span style="line-height: 0.42rem;">邀请新用户注册拍吖吖，关联推荐人关系。被邀请人首次参与花生团，并成功团得商品，推荐人将获得同等价值的花生。</span>
            </div>
        </div>
    </div>
</main>
