<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"D:\project\pai\public/../application/admin/view/search/search_hot.html";i:1541491287;s:64:"D:\project\pai\public/../application/admin/view/common/base.html";i:1543283930;}*/ ?>
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <table class="table table-hover" style="margin-bottom:0">
                ...
                <tr class="tr_<?php echo $vo['psh_id']; ?>">
                    <td><?php echo $vo['psh_id']; ?></td>
                    <td><?php echo $vo['psh_keyword']; ?></td>
                    <td><?php echo $vo['psh_sort']; ?></td>
                    <td>
                        <button type="button" class="btn btn-danger" onclick='del("<?php echo $vo['psh_id']; ?>")'>
                            删除
                        </button>
                        <a href="/admin/search/add_hot/psh_id/<?php echo $vo['psh_id']; ?>" type="button" class="btn btn-danger">
                            编辑
                        </a>
                    </td>
                </tr>
