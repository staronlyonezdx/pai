<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:77:"D:\project\pai\public/../application/member/view/goodsproduct/fudai_rule.html";i:1541645858;s:65:"D:\project\pai\public/../application/member/view/common/base.html";i:1541491283;s:67:"D:\project\pai\public/../application/member/view/common/js_sdk.html";i:1541491283;}*/ ?>
...
<main>
    ...
    <div class="rule_main">
        <div class="rule_list rule_list_fudai">
            <div class="rule_bg_img rule_fudai">
                <img src="__STATIC__/image/goodsproduct/icon@2x.png" alt=""/>
            </div>
            <p>超值福袋商品参购流程</p>
        </div>
        <div class="rule_main_img rule_main_img_fudai">
            <!-- 加判断S -->
            <?php if($is_lord ==1): ?>
            <img src="__STATIC__/image/goodsproduct/liuchengfudai@2x.png" alt=""/>
            <?php else: ?>
            <img src="__STATIC__/image/goodsproduct/liuchengfudai@2x.png" alt=""/>
            <?php endif; ?>
            <!-- 加判断E -->
        ...
        <div>
            ...
            <div class="rule_mian_text">
                 <span>超值购是拍吖吖推出新的福利活动，用户可以用低价换得超出付款价值的商品，每个超值福袋更会有一人获得惊喜大福袋，惊喜大福袋是价值更高于超值福袋的商品。</span>
                <!--<a href="/member/orderpai/pai_rule/">查看详细揭晓规则</a>-->
                <a href="/promotion/index/hd_gz1">查看详细福袋规则</a>
            </div>
        </div>
        <!-- <div>
            <div class="rule_list">
