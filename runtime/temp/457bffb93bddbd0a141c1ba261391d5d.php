<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"D:\project\pai\public/../application/admin/view/pointgoods/goodslist.html";i:1543549811;s:64:"D:\project\pai\public/../application/admin/view/common/base.html";i:1543283930;}*/ ?>
        ...
        <div class="panel-body">
            <div class="form-group  from_add_authority">
                ...
                <span class="select_box">
                    <label> 商品状态:</label>
                    <a href="/admin/Pointgoods/goodslist/g_state/2" type="button" class="btn <?php if($g_state == '2'): ?>btn-success <?php else: ?> btn-info <?php endif; ?> btn-xs">待审核</a>
                    <a href="/admin/Pointgoods/goodslist/g_state/6" type="button" class="btn <?php if($g_state == '6'): ?>btn-success <?php else: ?> btn-info <?php endif; ?> btn-xs">审核通过</a>
                    <a href="/admin/Pointgoods/goodslist/g_state/4" type="button" class="btn <?php if($g_state == '4'): ?>btn-success <?php else: ?> btn-info <?php endif; ?> btn-xs">审核失败</a>
                </span>
            </div>
            ...
            <table class="table table-hover table-bordered" style="margin-bottom:0">
                ...
                <tr>
                    ...
                    <td>
                        <p>开始日期:<?php if(!(empty($vo['g_starttime']) || (($vo['g_starttime'] instanceof \think\Collection || $vo['g_starttime'] instanceof \think\Paginator ) && $vo['g_starttime']->isEmpty()))): ?><?php echo date("m-d H:i",$vo['g_starttime']); else: ?>通过立即开拍<?php endif; ?></p>
                        <p>结束日期:<?php if(!(empty($vo['g_endtime']) || (($vo['g_endtime'] instanceof \think\Collection || $vo['g_endtime'] instanceof \think\Paginator ) && $vo['g_endtime']->isEmpty()))): ?><?php echo date("m-d H:i",$vo['g_endtime']); endif; ?></p>
                        <p>申请时间:<?php if(!(empty($vo['g_addtime']) || (($vo['g_addtime'] instanceof \think\Collection || $vo['g_addtime'] instanceof \think\Paginator ) && $vo['g_addtime']->isEmpty()))): ?><?php echo date("m-d H:i",$vo['g_addtime']); endif; ?></p>
                        <p>审核时间:<?php if(!(empty($vo['g_audittime']) || (($vo['g_audittime'] instanceof \think\Collection || $vo['g_audittime'] instanceof \think\Paginator ) && $vo['g_audittime']->isEmpty()))): ?><?php echo date("m-d H:i",$vo['g_audittime']); endif; ?></p>
                    </td>
                    <td>
                        <p>市场价：<?php echo $vo['gp_market_price']; ?></p>
                        <p>结算价：<?php echo $vo['gp_settlement_price']; ?></p>
                        <p>快递费：<?php echo $vo['g_express']; ?></p>
                    </td>
                    ...
                    <td>
                        <?php if($vo['g_state'] == 2 || $vo['g_state'] == 4): ?>
                            <input type="text" class='heat is_heat<?php echo $vo['g_id']; ?>' value="<?php echo $vo['is_heat']; ?>">
                        <?php else: if($vo['is_heat'] == 0): ?> 非热拍<?php else: ?><?php echo $vo['is_heat']; endif; endif; ?>
                    </td>
                    <td>
                        <?php if($vo['g_state'] == 2 || $vo['g_state'] == 4): ?>
                            <input type="text" class='gp_gift_peanut<?php echo $vo['g_id']; ?>' value="<?php echo $vo['gp_gift_peanut']; ?>">
                        <?php elseif($vo['g_state'] == 6): ?>
                            <?php echo $vo['gp_gift_peanut']; endif; ?>
                    </td>
                    <td >
                        <?php if($vo['g_state'] == 2 || $vo['g_state'] == 4): ?>
                            <input type="text" class='g_limited<?php echo $vo['g_id']; ?>' value="<?php echo $vo['g_limited']; ?>">
                        <?php elseif($vo['g_state'] == 6): ?>
                            <?php echo $vo['g_limited']; endif; ?>
