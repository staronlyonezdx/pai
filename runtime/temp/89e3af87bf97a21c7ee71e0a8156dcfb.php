<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"D:\project\pai\public/../application/admin/view/menu/menulist.html";i:1541491287;s:64:"D:\project\pai\public/../application/admin/view/common/base.html";i:1543283930;}*/ ?>
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <table class="table table-hover" style="margin-bottom:0">
                ...
                <tbody>
              <?php if(is_array($menulist) || $menulist instanceof \think\Collection || $menulist instanceof \think\Paginator): $i = 0; $__LIST__ = $menulist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?></td>
                    <td><?php echo $vo['menu_id']; ?></td>
                    <td><span style="font-weight:bold;color:red"><?php echo $vo['menu_name']; ?></span></td>
                    <td><?php echo $vo['menu_parent_name']; ?></td>
                    <td><?php echo $vo['menu_sort']; ?></td>
                    <td><?php echo $vo['authstr']; ?></td>
                    <td><?php echo $vo['menu_c']; ?></td>
                    <td><?php echo $vo['menu_url']; ?></td>
                    <td>
                        <a href="<?php echo url('menu/menuadd',['id'=>$vo['menu_id']]); ?>">
                            编辑
                        </a>
                  ...
                  <?php if(!(empty($vo['menu_son']) || (($vo['menu_son'] instanceof \think\Collection || $vo['menu_son'] instanceof \think\Paginator ) && $vo['menu_son']->isEmpty()))): if(is_array($vo['menu_son']) || $vo['menu_son'] instanceof \think\Collection || $vo['menu_son'] instanceof \think\Paginator): $i = 0; $__LIST__ = $vo['menu_son'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo_son): $mod = ($i % 2 );++$i;?>
                <tr>
                  <td><?php echo $vo_son['menu_id']; ?></td>
                  <td><?php echo $vo_son['menu_name']; ?></td>
                  <td><?php echo $vo_son['menu_parent_name']; ?></td>
                  <td><?php echo $vo_son['menu_sort']; ?></td>
                  <td><?php echo $vo_son['authstr']; ?></td>
                  <td><?php echo $vo_son['menu_c']; ?></td>
                    <td><?php echo $vo_son['menu_url']; ?></td>
                  <td>
                      <a href="<?php echo url('menu/menuadd',['id'=>$vo_son['menu_id']]); ?>">
                          编辑
                      </a>
                      <a href="##" class="authoritylist_dele_btn">
                          删除
