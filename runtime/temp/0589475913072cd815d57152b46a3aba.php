        ...
        <div class="page-container">
            <form class="form form-horizontal" id="form-article-add">
                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        <input type="number" class="input-text" value="<?php echo isset($info['gp_sale_price']) ? $info['gp_sale_price'] :  ''; ?>" placeholder="" id="gp_sale_price" name="gp_sale_price" >
                    </div>
                </div>
                <div class="row cl">
                    <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>未中拍返回花生：</label>
                    <div class="formControls col-xs-8 col-sm-9">
                        <input type="number" class="input-text" value="<?php echo (isset($info['gp_gift_peanut']) && ($info['gp_gift_peanut'] !== '')?$info['gp_gift_peanut']:''); ?>" placeholder="未中拍返回花生" id="gp_gift_peanut" name="gp_gift_peanut" disabled="disabled" >
                    </div>
                </div>
                <div class="row cl">
                    <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>成团人数：</label>
                    <div class="formControls col-xs-8 col-sm-9">
                        <input type="number" class="input-text" value="<?php echo (isset($info['g_peoplenumber']) && ($info['g_peoplenumber'] !== '')?$info['g_peoplenumber']:''); ?>" placeholder="未中拍返回花生" id="g_peoplenumber" name="g_peoplenumber">
                    </div>
                </div>
                <div class="row cl">
                ...
                <div class="row cl" id="kdf">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        <input type="number" class="input-text" value="<?php echo isset($info['g_express']) ? $info['g_express'] :  ''; ?>" placeholder="" id="g_express" name="g_express" disabled="disabled" >
                    </div>
                </div>
                <div class="row cl">
                    <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>拍品描述：</label>
                    <div class="formControls col-xs-8 col-sm-9"> 
                        <script id="editor" type="text/plain" style="width:100%;height:400px;"><?php echo isset($info['g_description']) ? $info['g_description'] :  ''; ?></script></div>
                </div>
                <div class="row cl">
...
//    })
    ...
    $('#gp_sale_price').keyup(function(){
            ...
            var gp_gift_peanut = gp_sale_price* <?php echo isset($gp_gift_peanut) ? $gp_gift_peanut :  0; ?> ;
