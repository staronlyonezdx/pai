    ...
    $(function () {
        ...
        var mescroll = new MeScroll("body", {
            ...
            up: {
                ...
                empty: {
                    icon: "/static/image/wallet/pic_invite_null@2x.png", //图标,默认null
                    tip: "没有提现中的金额哦！", //提示
                },
        ...
        function setListData(curPageData) {
            ...
            for (var i = 0; i < curPageData.length; i++) {
                ...
                html += ' <p>'+pd.w_money+'</p>';
                html += ' <span class="taking_success">'+pd.s_state_name+'</span>';
                html += ' </div>';
                html += '</div>';
                html += ' </a>';
