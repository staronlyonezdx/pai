<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"D:\project\pai\public/../application/admin/view/systemmsg/index.html";i:1541491288;s:64:"D:\project\pai\public/../application/admin/view/common/base.html";i:1543283930;}*/ ?>
	...
	<div class="panel panel-default">
		<div class="panel-body">
			<div class="form-group  from_add_authority">
				<label>系统消息列表</label>
				<a class="pull-right" href="<?php echo url('systemmsg/sendmsg'); ?>">添加系统消息</a>
			</div>
			<table class="table table-hover" style="margin-bottom:0">
				...
				<tr>
					<th scope="row" class="sid"><?php echo $vo['sm_id']; ?></th>
					<td><?php echo $vo['sm_title']; ?></td>
					<td><?php echo $vo['sm_type']; ?></td>
					<td><?php echo $vo['sm_brief']; ?></td>
					<td class="sm_content"><?php echo $vo['sm_content']; ?></td>
					<td><?php echo $vo['to_mid']; ?></td>
				</tr>
