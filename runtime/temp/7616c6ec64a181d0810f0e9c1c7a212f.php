<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"D:\project\pai\public/../application/admin/view/goodscategory/index.html";i:1541491287;s:64:"D:\project\pai\public/../application/admin/view/common/base.html";i:1543283930;}*/ ?>
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <div class="form-group  from_add_authority">
                <label>商品分类列表</label>
                <a class="pull-right" href="<?php echo url('goodscategory/edit'); ?>">添加分类</a>
            </div>
            <table class="table table-hover" style="margin-bottom:0">
                ...
                <tr>
                    <th scope="row" class="sid"><?php echo $vo['gc_id']; ?></th>
                    <td><img src="__CDN_PATH__<?php echo (isset($vo['gc_img']) && ($vo['gc_img'] !== '')?$vo['gc_img']:''); ?>"></td>
                    <td><img src="__CDN_PATH__<?php echo (isset($vo['gc_banner_img']) && ($vo['gc_banner_img'] !== '')?$vo['gc_banner_img']:''); ?>"></td>
                    <td><?php echo $vo['gc_name']; ?></td>
                    <td><?php echo $vo['pname']; ?></td>
                    <td><?php echo $vo['level']; ?></td>
                    <td><?php if($vo['gc_is_tj'] > 0): ?>是<?php else: ?>否<?php endif; ?></td>
                    <td><?php if($vo['state'] == 0): ?>显示<?php else: ?>不显示<?php endif; ?></td>
                    <td>0</td>
                    <td>
                        <a href="<?php echo url('goodscategory/edit',['gc_id' => $vo['gc_id']]); ?>">
                            编辑
                        </a>
                        <a href="<?php echo url('goodscategory/delete',['gc_id' => $vo['gc_id']]); ?>" class="dele_btn">
                            删除
                        </a>
