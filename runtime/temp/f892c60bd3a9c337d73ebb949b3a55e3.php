<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:77:"D:\project\pai\public/../application/pointpai/view/pointorder/pay_result.html";i:1541577949;s:67:"D:\project\pai\public/../application/pointpai/view/common/base.html";i:1541677267;s:69:"D:\project\pai\public/../application/pointpai/view/common/js_sdk.html";i:1541491294;}*/ ?>
...
<main>
    ...
    <div class="payment_success">
        <div class="payment_success_tit ">
            <div class="payment_success_con clear">
                ...
                <a href="/pointpai/Pointorder/index/o_id/<?php echo $info['o_id']; ?>/j_type/1">
        ...
        <div class="payment_success_bottom">
            <div class="payment_success_list clear">
                ...
                <p class="rt">
                    <?php switch($info['o_paytype']): case "1": ?>微信<?php break; case "2": ?>支付宝<?php break; case "3": ?>余额支付<?php break; case "4": ?>积分支付<?php break; default: ?>默认
                    <?php endswitch; ?>
                </p>
            </div>
            <div class="payment_success_list clear">
            ...
            <div class="payment_success_list clear">
                <p class="lf">订单总额</p>
                <p class="rt"><?php echo (isset($info['o_totalpoint']) && ($info['o_totalpoint'] !== '')?$info['o_totalpoint']:'0.00'); ?>积分</p>
            </div>
        </div>
    ...
    <a href="/pointpai/pointgoods/goods_list"><div class="payment_success_btn" style="background:linear-gradient(90deg,rgba(255,111,35,1),rgba(255,172,44,1));color:#fff">再去逛逛宝贝~</div></a>
    <!--支付失败-->
    <?php else: ?>
    <style>
        body{
    ...
    <a href="/pointpai/Pointorder/index/o_id/<?php echo (isset($o_id) && ($o_id !== '')?$o_id:0); ?>">
        <div class="payment_failure_btn" style="background:linear-gradient(90deg,rgba(255,111,35,1),rgba(255,172,44,1));color:#fff">再次支付</div>
    </a>
