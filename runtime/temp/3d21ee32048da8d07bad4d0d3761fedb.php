<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:77:"D:\project\pai\public/../application/pointpai/view/review/gp_review_list.html";i:1541491295;s:67:"D:\project\pai\public/../application/pointpai/view/common/base.html";i:1541677267;s:69:"D:\project\pai\public/../application/pointpai/view/common/header.html";i:1541491294;s:69:"D:\project\pai\public/../application/pointpai/view/common/js_sdk.html";i:1541491294;}*/ ?>
        ...
        function setListData(curPageData) {
            ...
            for (var i = 0; i < curPageData.length; i++) {
                ...
                if(pd.goods_score == '5.0') {
                    star = '/static/image/review/icon_huang@2x.png';
                }else if(pd.goods_score == '4.0') {
                    star = '/static/image/review/star4.png';
                }else if(pd.goods_score == '3.0') {
                    star = '/static/image/review/star3.png';
                }else if(pd.goods_score == '2.0') {
                    star = '/static/image/review/star2.png';
                }else if(pd.goods_score == '1.0') {
                    star = '/static/image/review/star1.png';
                }
                ...
                if(pd.m_avatar == null) {
                    pd.m_avatar = '/static/image/index/pic_home_taplace@2x.png';
                }
                ...
                str += '<p class="scd">'+ pd.s_name +'<span>第'+ pd.o_periods +'轮购中人</span></p>';
                str += '</div>';
                if(pd.goods_score != null) {
                    str += '<div class="details_evaluate_star rt ptd">';
                ...
                str += '</div>';
                str += '<div class="time-db">'+ msToDate(pd.o_paytime * 1000).wasTime +'&nbsp;&nbsp;&nbsp;&nbsp;共'+pd.pai_num+'份吖吖码</div>';
                str += '</div>';
                str += '</div>';
        ...
        * */
        function getListDataFromNet(pageNum, pageSize, successCallback, errorCallback) {
            ...
            setTimeout(function () {
                $.ajax({
                    type: 'get',
                    url: '/pointpai/review/get_gp_review_list/gp_id/'+ gp_id +'/page/' + pageNum + '/page_size/' + pageSize,
                    data: {},
                    dataType: 'json',
