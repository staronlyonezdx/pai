<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"D:\project\pai\public/../application/admin/view/webimagestype/index.html";i:1541491288;s:64:"D:\project\pai\public/../application/admin/view/common/base.html";i:1543283930;}*/ ?>
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <div class="form-group  from_add_authority">
                <label>广告图片列表</label>
                <a class="pull-right" href="<?php echo url('Webimagestype/edit'); ?>">添加分类</a>
            </div>
            <table class="table table-hover" style="margin-bottom:0">
                ...
                <tr>
                    <th scope="row" class="sid"><?php echo $vo['wit_id']; ?></th>
                    <td><?php echo $vo['wit_name']; ?></td>
                    <td><?php echo $vo['wit_code']; ?></td>
                    <td>
                        <a href="<?php echo url('Webimagestype/edit',['wit_id' => $vo['wit_id']]); ?>">
                            编辑
                        </a>
                        <a href="<?php echo url('Webimagestype/delete',['wit_id' => $vo['wit_id']]); ?>" class="dele_btn">
                            删除
                        </a>
                    </td>
                </tr>
