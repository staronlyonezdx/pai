<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"D:\project\pai\public/../application/admin/view/api/apitokenadd.html";i:1541491286;s:64:"D:\project\pai\public/../application/admin/view/common/base.html";i:1543283930;}*/ ?>
...
<form method="post" action="<?php echo url('api/apitokenadd_do'); ?>" id="add_store_category_form" enctype="multipart/form-data">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <div class="form-group from_add_margin">
                    <label>API账号</label>
                    <input type="text" class="form-control" placeholder="API账号" name="at_name" <?php if(!(empty($data) || (($data instanceof \think\Collection || $data instanceof \think\Paginator ) && $data->isEmpty()))): ?> value="<?php echo $data['at_name']; ?>" <?php endif; ?>>
                </div>
                <?php if(empty($data) || (($data instanceof \think\Collection || $data instanceof \think\Paginator ) && $data->isEmpty())): ?>
                <div class="form-group">
                    <label>API密码</label>
                    <input type="text" class="form-control" placeholder="API密码" name="at_pwd" <?php if(!(empty($data) || (($data instanceof \think\Collection || $data instanceof \think\Paginator ) && $data->isEmpty()))): ?> value="<?php echo $data['at_pwd']; ?>" <?php endif; ?>>
                </div>
                <?php endif; ?>
                <div class="form-group">
                    <label>APITOKEN</label>
                    <input type="text" class="form-control" placeholder="APITOKEN" name="at_token" <?php if(!(empty($data) || (($data instanceof \think\Collection || $data instanceof \think\Paginator ) && $data->isEmpty()))): ?> value="<?php echo $data['at_token']; ?>" <?php endif; ?>>
                </div>
                <div class="form-group">
                    <label>请求间隔</label>
                    <input type="text" class="form-control" placeholder="请求间隔" name="at_interval_time" <?php if(!(empty($data) || (($data instanceof \think\Collection || $data instanceof \think\Paginator ) && $data->isEmpty()))): ?> value="<?php echo $data['at_interval_time']; ?>" <?php endif; ?>>
                </div>
            ...
            <div class="form-group text-right" style="margin-top:20px">
                    <input type="hidden" <?php if(!(empty($data) || (($data instanceof \think\Collection || $data instanceof \think\Paginator ) && $data->isEmpty()))): ?> value="<?php echo $data['at_id']; ?>"  <?php endif; ?> name="at_id"/>
