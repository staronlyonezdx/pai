<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"D:\project\pai\public/../application/admin/view/banklogo/index.html";i:1542704491;s:64:"D:\project\pai\public/../application/admin/view/common/base.html";i:1543283930;}*/ ?>
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <table class="table table-hover" style="margin-bottom:0">
                    ...
                    <tbody>
                    <?php if(is_array($clist) || $clist instanceof \think\Collection || $clist instanceof \think\Paginator): $i = 0; $__LIST__ = $clist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$citem): $mod = ($i % 2 );++$i;?>
                    <tr>
                        <td><?php echo $citem['b_id']; ?></td>
                        <td><?php echo $citem['b_bankname']; ?></td>
                        <td><?php echo $citem['b_bankcode']; ?></td>
                        <td><?php echo $citem['b_bankcolor']; ?></td>
                        <td><img style="height: 25px;width: 25px;" src="__CDN_PATH__<?php echo (isset($citem['b_banklogo']) && ($citem['b_banklogo'] !== '')?$citem['b_banklogo']:''); ?>"></td>
                        <td>
                            <a href="<?php echo url('banklogo/addpage',['b_id'=>$citem['b_id']]); ?>">
                                编辑
                            </a>
                            <a href="<?php echo url('banklogo/delete',['b_id'=>$citem['b_id']]); ?>" onclick="if(!confirm('确认要删除么?')) return false;" class="authoritylist_dele_btn">
                                删除
                            </a>
                        </td>
                    </tr>
