<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:76:"D:\project\pai\public/../application/member/view/wallet/untie_bank_card.html";i:1542675499;s:65:"D:\project\pai\public/../application/member/view/common/base.html";i:1543280491;s:67:"D:\project\pai\public/../application/member/view/common/header.html";i:1542767234;s:67:"D:\project\pai\public/../application/member/view/common/js_sdk.html";i:1541491283;}*/ ?>
        ...
        <div class="untie_bank_card">
            ...
            <ul>
                <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$bank): $mod = ($i % 2 );++$i;?>
                    <li data-id="<?php echo $bank['id']; ?>"><?php echo $bank['bankname']; ?>储蓄卡尾号(<?php echo substr($bank['bankaccount'] ,15,4); ?>)<span>已选</span></li>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </ul>
        </div>
        <div class="bookcard_btn">当前还暂未选择解绑卡号</div>
        <div class="bookcard_btn active_btn showCount">已选0张，我要解绑</div>
    </div>
</main>
...
<script>
    ...
    $('.untie_bank_card').find('li').off('click').on('click',function(){
        ...
        $('.showCount').html('已选'+count+'张，我要解绑')
        if(hasActive){
            $('.active_btn').show();
        }else{
            $('.active_btn').hide();
