<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"D:\project\pai\public/../application/admin/view/webimages/index.html";i:1541491288;s:64:"D:\project\pai\public/../application/admin/view/common/base.html";i:1543283930;}*/ ?>
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <div class="form-group  from_add_authority">
                <label>广告图片列表</label>
                <a class="pull-right" href="<?php echo url('Webimages/edit'); ?>">添加图片</a>
            </div>
            <table class="table table-hover" style="margin-bottom:0">
                ...
                <tr>
                    <th scope="row" class="sid"><?php echo $vo['wi_id']; ?></th>
                    <td><img src="__CDN_PATH__<?php echo $vo['wi_imgurl']; ?>" width="50px"></td>
                    <td><?php echo $vo['wi_name']; ?></td>
                    <td><?php echo $vo['wit_name']; ?></td>
                    <td>
                    <?php switch($vo['wi_type']): case "'0'": ?>PC<?php break; case "1": ?>h5<?php break; case "2": ?>app<?php break; endswitch; ?>
                    </td>
                    <td><?php if($vo['wi_state'] == 0): ?>显示<?php else: ?>不显示<?php endif; ?></td>
                    <td><?php echo $vo['wi_href']; ?></td>
                    <td><?php echo $vo['wi_info']; ?></td>
                    <td><?php echo $vo['wi_sort']; ?></td>
                    <td>
                        <?php switch($vo['wi_linktype']): case "1": ?>商品id<?php break; case "2": ?>目录id<?php break; case "3": ?>活动<?php break; endswitch; ?>
                    </td>
                    <td><?php echo $vo['wi_linkid']; ?></td>
                    <td><?php echo $vo['wi_linkcontent']; ?></td>
                    <td>
                        <a href="<?php echo url('Webimages/edit',['wi_id' => $vo['wi_id']]); ?>">
                            编辑
                        </a>
                        <a href="<?php echo url('Webimages/delete',['wi_id' => $vo['wi_id']]); ?>" class="dele_btn">
                            删除
                        </a>
                    </td>
                </tr>
