<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"D:\project\pai\public/../application/member/view/wallet/surplus_book.html";i:1541491284;s:65:"D:\project\pai\public/../application/member/view/common/base.html";i:1542013165;s:67:"D:\project\pai\public/../application/member/view/common/js_sdk.html";i:1541491283;}*/ ?>
...
<link rel="stylesheet" type="text/css" href="__CSS__/wallet/surplus_book.css"> 
...
<div class="head-blue">
    <div class="back-withe" onclick="javascript:history.back(-1);"></div>
...
<script type="text/javascript" charset="utf-8">
    $(function () {
        ...
        function getListDataFromNet(curNavIndex, pageNum, pageSize, successCallback, errorCallback) {
            if (curNavIndex == 0) {
                var url = '/member/wallet/surplus_book/page/' + pageNum + '/page_size/' + pageSize;
            } else if (curNavIndex == 1) {
                url = '/member/wallet/surplus_book/ml_type/add/page/' + pageNum + '/page_size/' + pageSize;
            } else if (curNavIndex == 2) {
                url = '/member/wallet/surplus_book/ml_type/reduce/page/' + pageNum + '/page_size/' + pageSize;
            }
            //延时一秒,模拟联网
            setTimeout(function () {
                $.ajax({
