...
<section class="Hui-article-box">
    ...
    <div class="Hui-article">
        <div class="page-container">
            <h3 class="text-c red">
                <?php switch($type): case "1": ?>普通商品<?php break; case "2": ?>福袋商品<?php break; case "3": ?>福袋商品<?php break; default: ?>普通商品发布
                <?php endswitch; ?>
            </h3>
