<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"D:\project\pai\public/../application/admin/view/search/add_hot.html";i:1541491287;s:64:"D:\project\pai\public/../application/admin/view/common/base.html";i:1543283930;}*/ ?>
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <div class="form-group  from_add_authority">
                ...
                <label> <?php if($info['psh_id'] != ""): ?>编辑<?php else: ?>添加<?php endif; ?>热搜消息</label>
                <div class="c"></div>
            </div>
            <form action="/admin/search/add_hot" method="post">
                <div class="form-group from_add_margin">
                    <label>热搜关键词</label>
                    <input type="text" name="psh_keyword" class="form-control" placeholder="热搜关键词" value="<?php echo (isset($info['psh_keyword']) && ($info['psh_keyword'] !== '')?$info['psh_keyword']:''); ?>">
                </div>
                <div class="form-group from_add_margin">
                    <label>排序</label>
                    <input type="text" name="psh_sort" class="form-control" placeholder="排序" value="<?php echo (isset($info['psh_sort']) && ($info['psh_sort'] !== '')?$info['psh_sort']:''); ?>">
                </div>
                <div class="form-group text-right" style="margin-top:20px">
                    <?php if($info['psh_id'] != ""): ?>
                        <input type="hidden" name="psh_id" value="<?php echo isset($info['psh_id']) ? $info['psh_id'] :  ''; ?>"/>
                    <?php endif; ?>
